...
const ArticlesPage = () => {
  ...
  return (
    <div className="lg:pt-2 pt-12">
      {featuredArticles.length > 0 && (
        <div className="w-[100%] mx-auto pb-7 pt-0 relative linear-gradient-featured">
          <div className="absolute left-0 top-0 lg:p-2 p-1 lg:pr-6 pr-4 bg-secondary z-50 clip-featured">
            <h1 className="text-primary-foreground text-md text-center font-semibold uppercase">
              Featured articles
            </h1>
          </div>
          <Slider
          ...
          >
            {featuredArticles.map((article, idx) => {
              return (
                <div key={idx} className="wrapper flex items-start relative">
      ...
      <div className="flex items-start flex-wrap lg:justify-start justify-center lg:p-10 p-4 gap-4">
        {state.articles.map((article) => {
          return (
            <div
              key={article.id}
              className="max-w-[250px] sm:pb-10 pb-3 sm:border-b-0 border-b"
            >
